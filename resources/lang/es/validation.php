...
return [
    ...
    */
    ...
    'recaptcha' => 'El campo captcha no es correcto.',
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            'phone_number' => 'El valor no parece ser un número telefónico con formato aceptado.',
        ],
        'name' => [
            'alpha_spaces' => 'Este campo solo puede contener letras y espacios',
        ],
        'recaptcha' => 'El campo no es correcto.',
    ],
